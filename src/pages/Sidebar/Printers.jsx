            ...
            <div className="grid lg:grid-cols-3 gap-5 px-8">
              <div className="bg-white min-h-[420px] rounded-2xl shadow-2xl group">
                <div className="overflow-hidden flex items-center justify-center py-6">
                  <img src={printer1} alt="" className="w-[80%] h-48 object-cover rounded-2xl shadow-lg group-hover:scale-110 transition-all duration-300"/>
                </div>

                <div className="flex justify-end mx-6 mb-3">
                  <div className="px-4 py-2 rounded-3xl bg-green-300">status</div>
                </div>
              ...
              </div><div className="bg-white min-h-[420px] rounded-2xl shadow-2xl group">
                <div className="overflow-hidden flex items-center justify-center py-6">
                  <img src={printer1} alt="" className="w-[80%] h-48 object-cover rounded-2xl shadow-lg group-hover:scale-110 transition-all duration-300"/>
                </div>
