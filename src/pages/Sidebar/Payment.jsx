...
const Payment = () => {
    ...
    const confirmPayment = () => {
        setMessage('');
        setRemainingPages(prev => prev + parseInt(pages, 10));
    ...
    return (
        <div className="max-w-3xl mx-auto border-2 border-gray-300 rounded-lg p-8 mt-10 bg-gray-50">
            ...
            <div className="flex justify-between items-center mt-6">
                <p className="text-lg">Số trang còn lại : <span className="font-semibold">{remainingPages}</span></p>
                <button
                    ...
                    <table className="min-w-full bg-white border">
                        <thead>
                            <tr>
                                ...
                                <th className="px-4 py-2 border">Tổng số tiền</th> {/* Thêm cột Tổng số tiền */}
                        ...
                        <tbody>
                            {paymentHistory.length === 0 ? (
                                <tr>
                                    <td colSpan="6" className="text-center p-4">Chưa có giao dịch nào</td> {/* Sửa colSpan thành 6 */}
                                </tr>
                            ) : (
                                paymentHistory.map((payment) => (
                                    <tr key={payment.id}>
                                        <td className="px-4 py-2 border text-center">{payment.id}</td>
                                        ...
                                        <td className="px-4 py-2 border text-center">{payment.totalAmount}đ</td> {/* Hiển thị tổng số tiền */}
            ...
            {isSuccessModalOpen && (
                <div className="fixed inset-0 bg-gray-800 bg-opacity-75 flex items-center justify-center">
                    <div className="bg-white p-6 rounded-lg max-w-md w-full text-center">
                        ...
                        <p>Bạn đã thanh toán thành công {pages}.</p>
                        <button
